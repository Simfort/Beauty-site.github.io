import beautyITW from '../../../assets/beauty_itw.png'
import './BITW.scss'
export default function BeautyITW(){
    return <section className="beautyITW">
        <div className="wrapper-title">
        <h1 className="beautyITW-title">Beauty In The World</h1>
        </div>
        <div className="img-wrapper"> </div>
        <div className="beautyITW-text">
            <p>
